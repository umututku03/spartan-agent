...
illustrative result rather than a performance claim.
\end{abstract}
...
against a standardized benchmark; scaling the LLM-in-the-loop evaluation of Section~\ref{sec:llm}
(more assets, seeds, and a third-party benchmark harness); richer
