import { elizaLogger, type ICacheManager } from "@elizaos/core";
...
export class BirdeyeProvider {
    ...
    private async fetchWithCacheAndRetry<T extends BirdeyeApiResponse>({
        ...
        const val = await this.runtime.getCache<any>(cacheKey);
        ...
        await this.runtime.setCache<any>(cacheKey, data);
        return data as T;
    }
